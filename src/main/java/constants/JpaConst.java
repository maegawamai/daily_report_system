...
public class JpaConst {
    ...
    String EMP_COL_UPSATED_AT = "updated_at";//更新日時
    ...
    String REP_COL_CRETED_AT = "updated_at";//登録日時
    ...
    String Q_EMP_GET_ALL_DEF = "SELECT e FROM Employee AS e ODRDER BY e.id DESC";//query
    //全ての従業員の件数を取得する
